...
const envSchema = z.object({
  ...
  EXTERNAL_API_BASE_URL: z.string().url().default("https://dramabox.dramabos.my.id/api/v1"),
  EXTERNAL_API_LANG: z.string().trim().min(1).default("in"),
  EXTERNAL_API_CODE: z.string().trim().min(1).default("21A55D78359C03264096DDA0F8709949"),
