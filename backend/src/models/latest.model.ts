...
const latestSchema = new Schema(
  ...
  { collection: "dramas_latest", timestamps: true }
);

export type LatestDocument = InferSchemaType<typeof latestSchema>;
export const LatestModel = model("DramaLatest", latestSchema);
